Cálculo de Salários- Projeto 1 de logica da programação Desenvolva+

Este projeto é um programa simples em Java que calcula os salários líquidos de funcionários com base em seus salários brutos, considerando os descontos de INSS e Imposto de Renda (IR) conforme tabelas atuais.
